...
APIS = {
    ...
    'vehicle': {
        ...
        'extra_blacklist': ['Developer', 'Website', 'Provider', 'Mobile_API', 'transKey', 'message', 'attribution']
    },
    'vehicle_chalan': {                      # 🔥 NAYA
    ...
    'vehicle_to_number': {                    # 🔥 NAYA
        ...
        'extra_blacklist': ['attribution', 'message']
    },
    'pincode': {
    ...
    'family': {
        ...
        'extra_blacklist': ['support', 'owner', 'service']
    },
    'tg2num': {
